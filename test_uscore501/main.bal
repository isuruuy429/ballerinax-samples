...
isolated function getPatient(string id) returns uscore501:USCorePatientProfile|r4:FHIRError? {
    do {
        ...
        patient.identifier_system, patient.identifier_value, [patient.first_name], patient.last_name,
        <r4:HumanNameUse>patient.name_use, <r4:PatientGender>patientGender, <string>patient.birthdate,
        <r4:ContactPointSystem>patient.telecom_system, <string>patient.telecom_value,
        <r4:ContactPointUse>patient.telecom_use, <string>patient.address_city, <string>patient.address_postalcode,
...
isolated function addPatient(json patientPayload) returns uscore501:USCorePatientProfile|r4:FHIRError? {
    ...
    do {
        ...
        `INSERT INTO patients (patient_id, identifier_system, identifier_value, first_name, last_name, name_use, 
        telecom_system, telecom_value, telecom_use, gender, birthdate, address_use, address_line, address_city, 
        address_postalcode)
        VALUES (${patient.id}, ${identifierSystem}, ${identifierValue}, ${givenName}, ${familyName}, ${namesUse}, 
        ${telecomSystem}, ${telecomValue},${telecomUse},${patient.gender}, ${patient.birthDate}, ${addressUse}, 
        ${addressLine}, ${addressCity}, ${addressPostalCode})`);
